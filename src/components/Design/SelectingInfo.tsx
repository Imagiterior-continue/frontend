          ...
          : (
              <>
                <VStack spacing='10px' w='150px' position='absolute'>
                  ...
                  <Button h='30px' bg='rgba(0, 0, 0, 0)' _hover={{ bg: 'rgba(0, 0, 0, 0.08)' }} border='2px solid #FF2929' rounded='3px' color='#FF2929' onClick={onClick}>
      ...
      <Popover>
        <PopoverTrigger>
            <Button display={{ base: 'block', '2xl': 'none' }} bg={themeColor.main} _hover={{ bg: themeColor.main }} boxSize='40px' padding='5px' rounded='3px' boxShadow='xl'>
              <FaRegTrashAlt size='30px' color={themeColor.accentString}/>
            </Button>
          </PopoverTrigger>
